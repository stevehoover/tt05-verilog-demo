...
logic [5:2] FpgaPins_Fpga_CPU_result_a4;
   ...
   //
      ...
      //
         ...
         //
            ...
            // Staging of $result.
            always_ff @(posedge clk) FpgaPins_Fpga_CPU_result_a4[5:2] <= FpgaPins_Fpga_CPU_result_a3[5:2];
      ...
      //_/fpga_pins
         ...
         //_/fpga
            //_\source top.tlv 205   // Instantiated from /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv, 340 as: m4+hidden_solution.
               //_\source top.tlv 311   // Instantiated from top.tlv, 206 as: m5+call(m5__l(206)m5_call(if,m5_get(CalcLab), calc_solution, cpu_solution))
                  //_\source M5-FN-riscv_gen 0   // Instantiated from top.tlv, 312 as: m5+riscv_gen()
                     
                  //_\end_source
                  //_\source M5-FN-riscv_sum_prog 0   // Instantiated from top.tlv, 313 as: m5+riscv_sum_prog()
                  ...
                  //_|cpu
                     ...
                     //_\source /raw.githubusercontent.com/stevehoover/MESTCourse/main/tlvlib/riscvshelllib.tlv 44   // Instantiated from top.tlv, 537 as: m4+dmem(@4)
                        // Data Memory
                        //_@4
                  ...
                  //_|cpu
                     ...
                     // IMem
                     //_\source /raw.githubusercontent.com/stevehoover/MESTCourse/main/tlvlib/riscvshelllib.tlv 12   // Instantiated from top.tlv, 773 as: m4+imem(@1)
                     ...
                     //_\source /raw.githubusercontent.com/stevehoover/MESTCourse/main/tlvlib/riscvshelllib.tlv 27   // Instantiated from top.tlv, 778 as: m4+rf(m5_get(rf_rd_stage), m5_get(rf_wr_stage))
                        // Reg File
                        //_@3
