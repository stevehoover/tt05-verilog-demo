...
logic FETCH_Instr_Regs_pending_n1 [31:0],
      FETCH_Instr_Regs_pending_a0 [31:0];

// For |fetch/instr/regs$value.
logic [31:0] FETCH_Instr_Regs_value_a0 [31:0];
...
logic [40*8-1:0] FETCH_InstrMem_instr_str_a0 [13:0];
   ...
   //
      ...
      //
         ...
         // Scope: /regs[31:0]
         //
         for (regs = 0; regs <= 31; regs++) begin : L1gen_FETCH_Instr_Regs
            // Staging of $pending.
...
//_\TLV
   ...
   //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 6366   // Instantiated from tt_um_warpv.tlv, 64 as: m5+warpv_top()
      /* verilator lint_on WIDTH */  // Let's be strict about bit widths.
      //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 6368 as: m5+ifelse(m5__l(6368)m5_calc(m5_get(NUM_CORES) > 1), 1,
         //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 6391   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__1.
            // Single Core.
            
            
            //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 3776   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 6395 as: m5+cpu(/top)
            
            
            
               //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 3780 as: m5+ifelse(m5__l(3780)m5_call(if_var_ndef,OP5_00000_TYPE, 1, 0), 1,
                  //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 3781   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__2.
                     //_\source M5-FN-riscv_gen 0   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 3782 as: m5+call(m5_get(isa)⌈_gen⌉)
                        
                     //_\end_source
                  //_\end_source
               //_\end_source
               // Instruction memory and fetch of $raw.
               //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1689   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 3785 as: m5+call(m5_get(IMEM_MACRO_NAME), m5_get(PROG_NAME))
                  ...
                  //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1696 as: m5+ifelse(m5_get(FORMAL), 1,
                     //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ifelse.
                        //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ifelse.
                           //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ifelse.
                              //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1754   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__7.
                                 // Default to HARDCODED_ARRAY
                                 // For simulation
                                 // --------------
                                             
                                 // Define the program.
                                 //_\source M5-FN-riscv_cnt10_prog 0   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1760 as: m5+call(⌈riscv_⌉cnt10⌈_prog⌉)
                                 ...
                                 //_|fetch
                                    //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1775 as: m5+ifelse(m5_get(VIZ), 1,
                                       //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1776   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__8.
               ...
               //_|fetch
                  ...
                  //_/instr
                     ...
                     //_@0
                        ...
                        //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 3927 as: m5+ifelse(m5_get(FORMAL), 1,
                        ...
                        //_\source M5-FN-redirect_conditions 0   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 3949 as: m5+redirect_conditions()
                     ...
                     //_@0
                        ...
                        //_?$second_issue
                           //_/orig_inst
                              ...
                              //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 3973 as: m5+ifelse(m5_get(EXT_F), 1,
                        ...
                        //_?$valid_decode
                           //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 3986 as: m5+ifelse(m5_get(MORE_TO_DO_SUPPORTED), 1,
                              //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 3991   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__12.
                        ...
                        //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1965   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 3999 as: m5+call(m5_get(isa)⌈_decode⌉)
                           //_?$valid_decode
                              // =================================
                              ...
                              //_\source M5-FN-instr_types_decode 0   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1988 as: m5+instr_types_decode()
                                 /*SV_plus*/
                              ...
                              // Instruction decode.
                              //_\source M5-FN-riscv_decode_expr 0   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1991 as: m5+riscv_decode_expr()
                              ...
                              //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1993 as: m5+ifelse(m5_get(EXT_M), 1,
                                 //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 2000   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__14.
                                    assign FETCH_Instr_div_mul_a0 = 1'b0;
                                 //_\end_source
                              //_\end_source
                        
                              //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 2004 as: m5+ifelse(m5_get(EXT_F), 1,
                                 
                              //_\end_source
                        
                              //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 2062 as: m5+ifelse(m5_get(EXT_B), 1,
                           ...
                           //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 2109 as: m5+ifelse(m5_get(EXT_F), 1,
                     ...
                     //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 3432   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 4001 as: m5+call(⌈branch_pred_⌉m5_get(BRANCH_PRED))
                        //_@0
                     ...
                     //_@0
                        ...
                        //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 4126   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 4015 as: m5+operands(/instr, , /src, 2:1)
                        ...
                        //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 4019 as: m5+ifelse(m5_get(EXT_F), 1,
                     ...
                     // Instantiate the program.
                     //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 2143   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 4036 as: m5+call(m5_get(isa)⌈_exe⌉, @m5_get(EXECUTE_STAGE), @m5_get(RESULT_STAGE))
                        ...
                        //_@0
                           ...
                           //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 2164 as: m5+ifelse(m5_get(EXT_M), 1,
                              
                           //_\end_source
                     
                           //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 2203 as: m5+ifelse(m5_get(EXT_F), 1,
                              
                           //_\end_source
                     
                     
                           //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 2227 as: m5+ifelse(m5_get(EXT_B), 1,
                           ...
                           //_?$valid_exe
                              ...
                              //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 2340 as: m5+ifelse(m5_get(INJECT_RETURNING_LD), 1,
                                 //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 2341   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__22.
                              ...
                              //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 2393 as: m5+ifelse(m5_get(EXT_M), 1,
                              ...
                              //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 2414 as: m5+ifelse(m5_get(EXT_F), 1,
                                 
                              //_\end_source
                     
                              //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 2488 as: m5+ifelse(m5_get(EXT_B), 1,
                                 
                              //_\end_source
                     
                        // CSR logic
                        // ---------
                        //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1833   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 2612 as: m5+riscv_csrs(⌈⌉(m5_get(csrs))⌈⌉)
                        
                           
                           //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1788   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1836 as: m5+riscv_csr(m5__l(1836)m5_eval(m5__l(1836)m5_call(get,⌈csr_⌉m4_csr⌈_args⌉)))
                              //--------------
                              // CSR CYCLE
                              //--------------
                              //_@0
                              ...
                              //_@0
                                 ...
                                 //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1799 as: m5+ifelse(1, 1,
                                    //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1800   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__27.
                                    ...
                                    //_\end_source
                                 //_\end_source
                                 //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1811 as: m5+ifelse(1, RO,
                                    //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1814   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__30.
                           ...
                           //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1788   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1836 as: m5+riscv_csr(m5__l(1836)m5_eval(m5__l(1836)m5_call(get,⌈csr_⌉m4_csr⌈_args⌉)))
                              ...
                              //_@0
                                 ...
                                 //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1799 as: m5+ifelse(1, 1,
                                    //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1800   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__31.
                                       // hw_wr_mask conditioned by hw_wr.
                                 ...
                                 //_\end_source
                                 //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1811 as: m5+ifelse(1, RO,
                                    //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1814   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__34.
                                       // Next value of the CSR.
                           ...
                           //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1788   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1836 as: m5+riscv_csr(m5__l(1836)m5_eval(m5__l(1836)m5_call(get,⌈csr_⌉m4_csr⌈_args⌉)))
                              ...
                              //_@0
                                 ...
                                 //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1799 as: m5+ifelse(1, 1,
                                    //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1800   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__35.
                                       // hw_wr_mask conditioned by hw_wr.
                                 ...
                                 //_\end_source
                                 //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1811 as: m5+ifelse(1, RO,
                                    //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1814   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__38.
                                       // Next value of the CSR.
                           ...
                           //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1788   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1836 as: m5+riscv_csr(m5__l(1836)m5_eval(m5__l(1836)m5_call(get,⌈csr_⌉m4_csr⌈_args⌉)))
                              ...
                              //_@0
                                 ...
                                 //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1799 as: m5+ifelse(1, 1,
                                    //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1800   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__39.
                                       // hw_wr_mask conditioned by hw_wr.
                                 ...
                                 //_\end_source
                                 //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1811 as: m5+ifelse(1, RO,
                                    //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1814   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__42.
                                       // Next value of the CSR.
                           ...
                           //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1788   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1836 as: m5+riscv_csr(m5__l(1836)m5_eval(m5__l(1836)m5_call(get,⌈csr_⌉m4_csr⌈_args⌉)))
                              ...
                              //_@0
                                 ...
                                 //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1799 as: m5+ifelse(1, 1,
                                    //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1800   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__43.
                                       // hw_wr_mask conditioned by hw_wr.
                                 ...
                                 //_\end_source
                                 //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1811 as: m5+ifelse(1, RO,
                                    //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1814   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__46.
                                       // Next value of the CSR.
                           ...
                           //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1788   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1836 as: m5+riscv_csr(m5__l(1836)m5_eval(m5__l(1836)m5_call(get,⌈csr_⌉m4_csr⌈_args⌉)))
                              ...
                              //_@0
                                 ...
                                 //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1799 as: m5+ifelse(1, 1,
                                    //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1800   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__47.
                                       // hw_wr_mask conditioned by hw_wr.
                                 ...
                                 //_\end_source
                                 //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1811 as: m5+ifelse(1, RO,
                                    //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1814   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__50.
                                       // Next value of the CSR.
                        ...
                        //_\end_source
                        //_@0
                           //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1839   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 2614 as: m5+riscv_csr_logic()
                              //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1840 as: m5+ifelse(m5_get(csrs), ⌈⌉, ⌈⌉,
                                 //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1841   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__51.
                              ...
                              // Counter CSR
                              //
                              //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1848 as: m5+ifelse(m5__l(1848)m5_call(if_defined_as,NO_COUNTER_CSRS, 1, 1, 0), 1,
                                 //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1851   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__53.
                                    ...
                                    //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1862 as: m5+ifelse(m5_get(EXT_F), 1,
                                    ...
                                    //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1889 as: m5+ifelse(m5_get(EXT_F), 1,
                              ...
                              // For multicore CSRs:
                              //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1906 as: m5+ifelse(m5__l(1906)m5_calc(m5_get(NUM_CORES) > 1), 1,
                           ...
                           //_?$st_cond
                              ...
                              //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 3380   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 2631 as: m5+swizzle_4_store_bytes()
                           ...
                           //_?$second_issue_ld
                              //_/orig_load_inst
                                 ...
                                 //_?$spec_ld_cond
                                    //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 3391   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 2636 as: m5+sign_extend_4_load_bytes(! $raw_funct3[2])
                        ...
                        //_@0
                           ...
                           //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1929   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 2649 as: m5+riscv_rslt_mux_expr()
                              ...
                              //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 1937 as: m5+ifelse(m5_get(ANY_NON_PIPELINED_INSTRS), 1,
               ...
               //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 3165   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 4102 as: m5+dmem(/top)
                  // This macro assumes little-endian.
                  
               
                  
                  /* DMEM_STYLE: ARRAY */
                  //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 3171 as: m5+ifelse(m5_get(UETRV_PCORE), 1,
                     //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ifelse.
                        //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ifelse.
                           //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ifelse.
                              //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 3234   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__62.
                                 //_|fetch
                                    //_/instr
                                       //_@0
                                 ...
                                 //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 3267 as: m5+ifelse(m5_get(DMEM_STYLE), ARRAY,
                                    //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 3268   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__63.
                        ...
                        //_@0
                           ...
                           //_?$second_issue_ld
                              ...
                              //_/orig_load_inst
                                 ...
                                 //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 3369 as: m5+ifelse(m5_get(EXT_F), 1,
               ...
               //_|fetch
                  //_/instr
                     ...
                     // Reg Write
                     // =========
                     //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 4178   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 4108 as: m5+rf_wr(/instr, m5_get(REGS_RANGE), /instr$commit_dest_reg, /instr$dest_reg, /instr$rslt, /instr$reg_wr_pending, )
                        /* verilator lint_save */
                        /* verilator lint_on WIDTH */
                        //_@0
                           assign FETCH_Instr_wr_reg_a0[4:0] = FETCH_Instr_second_issue_a0 ? FETCH_Instr_OrigInst_dest_reg_a0 : FETCH_Instr_dest_reg_a0;
                        //_@0
                           //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 4184 as: m5+ifelse(m5_get(RF_STYLE), STUBBED,
                              //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 4189   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__67.
                              ...
                              //_\end_source
                           //_\end_source
                           //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 4197 as: m5+ifelse(m5_get(PENDING_ENABLED), 1,
                              //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 4198   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__68.
                                 // Write $pending along with $value, but coded differently because it must be reset.
                                 for (regs = 0; regs <= 31; regs++) begin : L1_FETCH_Instr_Regs //_/regs
                     ...
                     // FPU RF
                     // ======
                     //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 4113 as: m5+ifelse(m5_get(EXT_F), 1,
            ...
            //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 5680   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 6404 as: m5+cpu_viz.
               /* CPU_VIZ HERE */
               
               
               
               //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 4665   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 5685 as: m5+call(m5_get(isa)⌈_viz_logic⌉)
                  // Code that supports
                  //_|fetch
                     //_@0
                        //_/instr
               ...
               //_|fetch
                  //_@0
                     //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 5670   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 5688 as: m5+layout_viz(⌈left: 0, top: 0, width: 451, height: 251⌉, "#7AD7F0")
                        
                     //_\end_source
            
                     //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 4683   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 5690 as: m5+instruction_in_memory.
                     ...
                     //_/instr
                        //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 5206   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 5693 as: m5+instruction(⌈left: 10, top: 0⌉)
                           //_?$valid_decode
                              // For debug.
                        ...
                        //_\end_source
                        //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 4782   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 5694 as: m5+registers(/instr, int, Int RF, , 2, ⌈left: 350 + 605, top: 10⌉)
                           // /regs or /fpu_regs
                           ...
                           for (regs = 0; regs <= 31; regs++) begin : L1b_FETCH_Instr_Regs //_/regs
                              
                           end
                        //_\end_source
                        //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 5177   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 5695 as: m5+register_csr(/regcsr, ⌈left: 103 + 605, top: 190⌉)
                           //_/regcsr
                              
                        //_\end_source
                        //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 4869   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 5696 as: m5+pipeline_control_viz(/pipe_ctrl, ⌈left: 103 + 605, top: 265 + 18 * m5_get(num_csrs), width: 220, height: 330⌉)
                        ...
                        //_\end_source
                        //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 5697 as: m5+ifelse(m5_get(EXT_F), 1,
                           
                        //_\end_source
                        //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 5535   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 5702 as: m5+memory_viz(/bank[m5__l(5702)m5_calc(m5_get(ADDRS_PER_WORD)-1):0] , /mem[m5_get(DATA_MEM_WORDS_RANGE)], ⌈left: 10 + (550 + 605) -10 + m5__l(5702)m5_call(if,m5_get(EXT_F), ⌈m5_get(VIZ_MEM_LEFT_ADJUST)⌉, 0), top: 10⌉)
                           //_\source /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv 88   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 5536 as: m5+ifelse(m5__l(5536)m5_calc(m5__l(5536)m5_eq(m5_get(DMEM_STYLE), ARRAY) || m5__l(5536)m5_eq(m5_get(DMEM_STYLE), RANDOM)), 1,
                              //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 5537   // Instantiated from /raw.githubusercontent.com/stevehoover/tlvlib/3543cfd9d7ef9ae3b1e5750614583959a672084d/fundamentalslib.tlv, 89 as: m4+ANONYMOUS__71.
      ...
      //_\end_source
   //_\end_source
   //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 6354   // Instantiated from tt_um_warpv.tlv, 65 as: m5+warpv_makerchip_tb()
      
      
      //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 4205   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 6357 as: m5+call(m5_get(tb_macro_name))
         //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 1232   // Instantiated from /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv, 4206 as: m5+default_makerchip_tb()
            //_|fetch
               //_/instr
                  //_@0
      ...
      //_\end_source
   //_\end_source
   //_\source /raw.githubusercontent.com/stevehoover/warpv/bc141b721d1c863dc10305d6e3e4ba38a81dd2eb/warpv.tlv 6339   // Instantiated from tt_um_warpv.tlv, 66 as: m5+makerchip_pass_fail()
      //_|done
         //_@0
